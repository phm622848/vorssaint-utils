...
struct ClipboardFeatureStrings {
    ...
    let activationModeShortcut: String
    let activationModeDoubleControl: String
    let shortcut: String
    let shortcutCaption: String
    let doubleControlCaption: String
    let doubleControlPermission: String
    let doubleControlUnavailable: String
    ...
    static let enUS = ClipboardFeatureStrings(
        ...
        activation: "Open history",
        activationMode: "Activation",
        activationModeShortcut: "Keyboard shortcut",
        activationModeDoubleControl: "Double-press Control",
        ...
        doubleControlCaption: "Double-press Control to toggle the quick history window. The keyboard shortcut stays saved as a fallback you can switch back to anytime.",
        doubleControlPermission: "Grant Accessibility to use double-press Control.",
        doubleControlUnavailable: "Vorssaint could not start listening for double-press Control.",
    ...
    static let ptBR = ClipboardFeatureStrings(
        ...
        activation: "Abrir histórico",
        activationMode: "Ativação",
        activationModeShortcut: "Atalho de teclado",
        activationModeDoubleControl: "Pressionar Control duas vezes",
        ...
        doubleControlCaption: "Pressione Control duas vezes para alternar a janela rápida do histórico. O atalho de teclado continua salvo como opção para voltar quando quiser.",
        doubleControlPermission: "Conceda Acessibilidade para usar o duplo toque em Control.",
        doubleControlUnavailable: "O Vorssaint não conseguiu iniciar a escuta do duplo toque em Control.",
    ...
    static let es = ClipboardFeatureStrings(
        ...
        activation: "Abrir historial",
        activationMode: "Activación",
        activationModeShortcut: "Atajo de teclado",
        activationModeDoubleControl: "Pulsar Control dos veces",
        ...
        doubleControlCaption: "Pulsa Control dos veces para alternar la ventana rápida del historial. El atajo de teclado seguirá guardado por si quieres volver a él.",
        doubleControlPermission: "Concede Accesibilidad para usar la pulsación doble de Control.",
        doubleControlUnavailable: "Vorssaint no pudo empezar a escuchar la pulsación doble de Control.",
    ...
    static let de = ClipboardFeatureStrings(
        ...
        activation: "Verlauf öffnen",
        activationMode: "Aktivierung",
        activationModeShortcut: "Tastenkürzel",
        activationModeDoubleControl: "Control doppelt drücken",
        ...
        doubleControlCaption: "Drücke Control doppelt, um das Schnellfenster des Verlaufs ein- oder auszublenden. Das Tastenkürzel bleibt gespeichert, falls du später zurückwechseln willst.",
        doubleControlPermission: "Erteile Bedienungshilfe-Zugriff, um das doppelte Drücken von Control zu nutzen.",
        doubleControlUnavailable: "Vorssaint konnte das Überwachen des doppelten Control-Drucks nicht starten.",
    ...
    static let fr = ClipboardFeatureStrings(
        ...
        activation: "Ouvrir l'historique",
        activationMode: "Activation",
        activationModeShortcut: "Raccourci clavier",
        activationModeDoubleControl: "Appuyer deux fois sur Control",
        ...
        doubleControlCaption: "Appuyez deux fois sur Control pour afficher ou masquer la fenêtre rapide de l'historique. Le raccourci clavier reste enregistré si vous voulez y revenir.",
        doubleControlPermission: "Accordez l'autorisation Accessibilité pour utiliser le double appui sur Control.",
        doubleControlUnavailable: "Vorssaint n'a pas pu démarrer l'écoute du double appui sur Control.",
        ...
        openNow: "Ouvrir l'historique maintenant",
        pinned: "Épinglés",
        recent: "Récents",
        pin: "Épingler",
        unpin: "Désépingler",
    ...
    static let it = ClipboardFeatureStrings(
        ...
        activation: "Apri cronologia",
        activationMode: "Attivazione",
        activationModeShortcut: "Scorciatoia da tastiera",
        activationModeDoubleControl: "Premi Control due volte",
        ...
        doubleControlCaption: "Premi Control due volte per mostrare o nascondere la finestra rapida della cronologia. La scorciatoia da tastiera resta salvata se vuoi tornarci in seguito.",
        doubleControlPermission: "Concedi Accessibilità per usare il doppio tocco su Control.",
        doubleControlUnavailable: "Vorssaint non è riuscito ad avviare l'ascolto del doppio tocco su Control.",
        ...
        openNow: "Apri cronologia adesso",
        pinned: "Fissati",
        recent: "Recenti",
        pin: "Fissa",
        unpin: "Sblocca",
    ...
    static let ja = ClipboardFeatureStrings(
        ...
        activation: "履歴を開く",
        activationMode: "起動方法",
        activationModeShortcut: "キーボードショートカット",
        activationModeDoubleControl: "Control を 2 回押す",
        shortcut: "履歴ショートカット",
        shortcutCaption: "検索、固定項目、前のアプリへ貼り付ける ⌘1 から ⌘9 のショートカットを備えたクイックウインドウを開きます。",
        doubleControlCaption: "Control を 2 回押すと履歴のクイックウインドウを切り替えます。キーボードショートカットも保存されたままなので、いつでも戻せます。",
        doubleControlPermission: "Control の 2 回押しを使うにはアクセシビリティを許可してください。",
        doubleControlUnavailable: "Vorssaint は Control の 2 回押しの監視を開始できませんでした。",
    ...
    static let zhHans = ClipboardFeatureStrings(
        ...
        activation: "打开历史记录",
        activationMode: "唤起方式",
        activationModeShortcut: "键盘快捷键",
        activationModeDoubleControl: "双击 Control",
        shortcut: "历史快捷键",
        shortcutCaption: "打开快速窗口，支持搜索、固定项目，以及用 ⌘1 到 ⌘9 粘贴到上一个 App。",
        doubleControlCaption: "双击 Control 可显示或关闭历史快速窗口。原来的快捷键会继续保留，之后随时可以切回去。",
        doubleControlPermission: "使用双击 Control 需要授予辅助功能权限。",
        doubleControlUnavailable: "Vorssaint 无法开始监听双击 Control。",
